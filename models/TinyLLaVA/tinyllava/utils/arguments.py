...
class DataArguments:
    ...
    # load guided attn map
    guided_attn_map: bool = field(
        default=True, 
        metadata={"help": "Whether to enable guided attention map processing"}
    )
    validation_data_path: Optional[str] = None
    validation_image_folder: Optional[str] = None
